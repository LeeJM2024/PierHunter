...
def _major_minor_bucket(version: str) -> str:
    ...
    if not match:
        raise ValueError(f"Cannot derive major.minor bucket from Kotlin version: {version}")
...
def build_kotlin_bucket_pickles(
    pickle_dir: str,
    tpl_dex_dir: str,
    output_dir: str,
    threshold: float = 0.8,
...
def parse_args(argv: Optional[Sequence[str]] = None):
    parser = argparse.ArgumentParser(description="Build kotlin-stdlib major.minor bucket skeleton pickles")
