...
PHUNTER_TIMEOUT = _env_int("PHUNTER_TIMEOUT", 60 * 60)
PHUNTER_APK_PREWARM_TIMEOUT = _env_int("PHUNTER_APK_PREWARM_TIMEOUT", 30 * 60)
PHUNTER_HEARTBEAT_TIMEOUT = _env_int("PHUNTER_HEARTBEAT_TIMEOUT", 15 * 60)
